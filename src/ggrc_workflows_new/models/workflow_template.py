...
class WorkflowTemplate(mixins.Described, mixins.Slugged, mixins.Titled,
  ...
  _publish_attrs = ('archived', reflection.PublishOnly('latest_cycle_number'),
                    'occurrences', 'repeat_every', 'title', 'unit')
  DAY_UNIT = u'Day'
  WEEK_UNIT = u'Week'
  MONTH_UNIT = u'Month'
  ...
  occurrences = deferred.deferred(db.Column(db.Integer), 'WorkflowTemplate')
